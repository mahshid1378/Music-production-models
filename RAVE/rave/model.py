...
class RAVE(pl.LightningModule):
    ...
    def __init__(self, latent_size, sampling_rate, encoder, decoder, discriminator, phase_1_duration, gan_loss, valid_signal_crop,
        feature_matching_fun, num_skipped_features, audio_distance: Callable[[], nn.Module],
        multiband_audio_distance: Callable[[], nn.Module], n_bands: int = 16, balancer = None, 
        weights: Optional[Dict[str, float]] = None, warmup_quantize: Optional[int] = None, 
        pqmf: Optional[Callable[[], nn.Module]] = None, spectrogram: Optional[Callable] = None,
        update_discriminator_every: int = 2, n_channels: int = 1, input_mode: str = "pqmf", output_mode: str = "pqmf", 
        audio_monitor_epochs: int = 1,
        # for retro-compatibility
        enable_pqmf_encode: Optional[bool] = None, enable_pqmf_decode: Optional[bool] = None, is_mel_input: Optional[bool] = None,
        loss_weights = None
    ):
        super().__init__()
